...
initial-contexts { {} }
rsctl-property { AG((~p0 AND ~p1 AND ~p2 AND ~p3 AND ~p4 AND ~p5 AND ~p6 AND ~p7 AND ~p8 AND ~p9 AND ~p10 AND ~p11 AND ~p12 AND ~p13 AND ~p14 AND ~p15) IMPLIES E[{inc},{dec}]F(p0 AND p1 AND p2 AND p3 AND p4 AND p5 AND p6 AND p7 AND p8 AND p9 AND p10 AND p11 AND p12 AND p13 AND p14 AND p15)) }
